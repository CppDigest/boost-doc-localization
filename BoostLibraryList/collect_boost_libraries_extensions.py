...
def parse_args():
    ...
    parser.add_argument(
        ...
        metavar="REF",
        default=None,
        help=f"Version/ref for both .gitmodules and libraries.json (e.g. boost-1.90.0). "
             f"If not specified, uses {DEFAULT_GITMODULES_REF} for .gitmodules and {DEFAULT_LIBS_REF} for libraries.json",
    )
    parser.add_argument(
        "--output",
        "-o",
